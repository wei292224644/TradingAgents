...
class TradingAgentsGraph:
    ...
    def propagate(self, company_name, trade_date, asset_type: str = "stock", trading_mandate: str = ""):
        ...
        ``trading_mandate`` is an optional free-text intent/constraint that
        frames every agent prompt for this run. Empty by default.
        """
    ...
    def _run_graph(self, company_name, trade_date, asset_type: str = "stock", trading_mandate: str = ""):
