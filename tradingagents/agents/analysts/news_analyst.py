...
def create_news_analyst(llm):
    def news_analyst_node(state):
        ...
        system_message = (
            ...
            + """ Fact-check verifiable claims before reporting them as catalysts: if a headline asserts something checkable against basic public knowledge (e.g. a company joining a stock index, a listing, a regulatory approval), sanity-check it — a company that has never IPO'd cannot join an index of listed companies — before presenting it as a reliable event. Crypto-platform-sourced press (Bitget, Binance, and similar promotional blogs) is especially prone to this; flag implausible or unverifiable claims explicitly instead of taking them at face value."""
